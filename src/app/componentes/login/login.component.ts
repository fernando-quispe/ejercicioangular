...
@Component({
  selector: 'app-login',
  standalone: true,
  imports: [FormsModule, NgFor ,ReactiveFormsModule ,CommonModule, LoginComponent, BienvenidoComponent, ErrorComponent, RouterOutlet, RouterLink, RouterLinkActive, LayoutComponent],
